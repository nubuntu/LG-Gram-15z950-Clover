...
DefinitionBlock ("SSDT-0.aml", "SSDT", 2, "LGE   ", "DptfTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.H_EC.TBA7, FieldUnitObj)
    ...
    Scope (\_SB.PCI0.B0D4)
    {
        ...
        Method (SPPC, 1, Serialized)
        {
            ...
            Store (Arg0, \_SB.PCI0.LPCB.H_EC.CDPP)
            Store (\_SB.PCI0.LPCB.H_EC.CDPP, \_SB.PCI0.LPCB.H_EC.TBA7)
        ...
        Device (TMEM)
        {
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                If (\_SB.PCI0.LPCB.H_EC.ECAV)
                {
                    ...
                    Else
                    {
                        If (LGreater (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR6)), \_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR7))))
                        {
